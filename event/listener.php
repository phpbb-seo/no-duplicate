...
class listener implements EventSubscriberInterface
{
	...
	*/
	public function __construct(\phpbb\config\config $config, \phpbb\auth\auth $auth, \phpbb\user $user, $phpbb_root_path, $php_ext, \phpbbseo\usu\core\core $usu_core = null)
	{
